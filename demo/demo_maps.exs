...
IO.puts("\n7. Demonstrating get/2 with default values:")
IO.puts("   SimpleData.get(:key1) => #{inspect SimpleData.get(:key1)}")
IO.puts("   SimpleData.get(:nonexistent) => #{inspect SimpleData.get(:nonexistent)}")
IO.puts("   SimpleData.get(:nonexistent, :default) => #{inspect SimpleData.get(:nonexistent, :default)}")
